        ...
        {(!currentRun || currentRun.totalOrdersCount === 0) && !isLoadingRun && (
          <div className="bg-white p-12 rounded-3xl border border-slate-200 text-center space-y-4 shadow-sm">
            ...
            <div className="max-w-md mx-auto">
              <h3 className="text-lg font-bold text-slate-900">No Active Audit Dataset Loaded</h3>
              <p className="text-xs text-slate-500 mt-1">
                Upload your store sales export (`orders.csv`) and payment gateway export (`payments.csv`) to run revenue reconciliation.
              </p>
            </div>
            <button
